...
1. в каталоге team45.2 в корневой директории создайте json файл с информацией о юзере и названии версии linux - имена возьмите из соответствующих команд {user: ..., system: ...}
