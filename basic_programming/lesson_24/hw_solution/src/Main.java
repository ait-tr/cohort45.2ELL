...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        Printer.printResult(strings.length, strings[0].charAt(0),
        ...
        while (true) {
            ...
            Printer.printResult(array.length, array[0].charAt(0),
